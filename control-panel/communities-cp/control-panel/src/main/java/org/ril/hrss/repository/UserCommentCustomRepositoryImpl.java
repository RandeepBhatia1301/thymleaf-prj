...
import org.ril.hrss.model.UserComment;
...
public class UserCommentCustomRepositoryImpl implements UserCommentCustomRepository {
    ...
    public UserCommentCustomRepositoryImpl(MongoTemplate mongoTemplate) {
    ...
    public List<CommentTimeBaseCount> getUserCommentTimeBaseCountByContentIdBetweenStartAndEndDate(Integer contentTypeId, Integer subOrgId, String startDate, String endDate) {
        ...
        AggregationResults<CommentTimeBaseCount> groupResults = mongoTemplate.aggregate(agg, UserComment.class, CommentTimeBaseCount.class);
    ...
    public List<TopBlog> getTopCommentByContentIdBetweenStartAndEndDate(Integer contentTypeId, Integer subOrgId, String startDate, String endDate) {
        ...
        AggregationResults<TopBlog> groupResults = mongoTemplate.aggregate(agg, UserComment.class, TopBlog.class);
        return groupResults.getMappedResults();
    }
}
